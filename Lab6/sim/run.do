...
# Load project
  eval vsim -novopt -quiet -nocoverage +notimingchecks +nowarnTSCALE -sva -G/top/test/NUMBER_OF_TRANSACTIONS=$2 -G/top/test/random_case=$3  -G/top/test/seed=$4 -G/top/test/test_name=$5 top
